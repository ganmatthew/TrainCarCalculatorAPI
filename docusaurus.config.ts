...
const config: Config = {
  ...
  url: 'https://train-car-calculator-api.ganmatthew.workers.dev/',
  ...
  organizationName: 'ganmatthew', // Usually your GitHub org/user name.
  projectName: 'train-car-calculator-api', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Made by Matthew Gan. Built with Docusaurus.`,
    },
    prism: {
